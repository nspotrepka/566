...
def main(params):
    ...
    try:
        ...
        model = CycleVAEGAN(None, None, **checkpoint_hparams)
    except KeyError:
    ...
    if image_path is not None:
        ...
        fake_audio, _, _, _ = model.gen_a_to_b(image)
        ...
        cycle_image, _, _, _ = model.gen_b_to_a(fake_audio)
    ...
    if audio_path is not None:
        ...
        fake_image_path = os.path.join(dir, 'fake_' + base + ext_image)
        fake_image, _, _, _ = model.gen_b_to_a(audio)
        ...
        cycle_audio, _, _, _ = model.gen_a_to_b(fake_image)
